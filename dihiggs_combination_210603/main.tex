...
\begin{document}
    ...
    \title{1/2/3D VBF Combination Recommendations with the New MC Production}
    \author{Chris Milke}
    \date{3 June, 2021}
    ...
    \frame{
        ...
        \begin{itemize} {
            ...
            \item Multi-basis combination doesn't seem to improve things, maybe just use single basis
