...
\displayonecenter{$\mu S + B$: $\mu$-Scanning}{{\footnotesize
    ...
    Can assign a value of how (un)-reasonable a particular signal is,
...
}{results/k2v_scan_VBF_chan_allNP_samps_vbf_pd_vbf_inc161718_kl_1.0_mu}
...
{results/kl_scan_thesis_final0_1D_kl_samps_vbf_pd_vbf_inc161718_k2v_1.0_xs} %TODO replace with full systs
...
{results/2D_scan_thesis_omega0_kvv_kv_samps_vbf_pd_vbf_inc161718_kl1p00_exclusion} %TODO replace with full systs
