...
\frame{
    ...
    \begin{subfigure}{0.32\textwidth} 
        ...
        \caption{$VVh$\\$\kv=1.05\pm0.04$}
    \end{subfigure}
    \begin{subfigure}{0.32\textwidth}
        \input{diagrams/feyn_VVhh.tex}
        \caption{$VVhh$\\$-0.1 < \kvv < 2.2$}
    \end{subfigure}
    \begin{subfigure}{0.32\textwidth}
        \input{diagrams/feyn_hhh.tex} 
        \caption{$hhh$\\$-2.3 < \kl < 9.4$}
    \end{subfigure}
    \end{figure}
...
% −2.3 <κλ< 9.4 (−5.0 <κλ< 12.0) and −0.1 <κ2V< 2.2 (−0.4 <κ2V< 2.5)
...
\frame{
    ...
    \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
            \input{tables/theory/higgsproduction.tex}
...
\displaytwoV{The Large Hadron Collider}{
    ...
    \begin{itemize}
        ...
        %\item 60 interactions per bunch-crossing
            ...
            \item $L_{\textrm{inst}} = 2\times10^{-5} \textrm{fb}^{-1}$
