...
{solidarity/projective_solidarity_all}{Overview of all 660 variations (sorted by Sum-Total of all integrals)}
{solidarity/projective_solidarity_dump}{Closer look at top 10 variations}
...
{solidarity/solidarity_performance_kv1}

\displaythree{Performance Predictions with Different $\kv$}{
    Variations with non-SM $\kv$ values can also potentially help
}
{solidarity/solidarity_performance_kv0.5}
{solidarity/solidarity_performance_kv1}
{solidarity/solidarity_performance_kv1.5}
