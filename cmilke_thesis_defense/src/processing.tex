...
\frame{
    ...
    \includegraphics[width=\linewidth,height=0.9\textheight,keepaspectratio]{processing/jets}
}

% Flavor Tagging
\displaytwo{Flavor Tagging}{
    {\small Uses a recurrent Deep Learning neural net (DL1r) to distinguish b-jets from light-jets.
    Primarily takes advantage of secondary vertexing and impact parameter jet properties.}
}
{reconstruction/ip3d_z0_sig_2017}
{reconstruction/dl1_performance_ljet}
%{reconstruction/ip3d_sign_positive}
% TODO: DL1r is not a different architecture, it's just DL1 with a different input (jetfitter->RNNip)
...
\frame{
    ...
    Multi-jet events (and some $\ttbar$ events) are a massive (95\%) background.
